          ...
          <main className="relative z-1 space-y-48">
            ...
            >
              <article className={cn("flex flex-col bg-standard", styles.card)}>
                ...
                <p>
                  Harness our built-in ingestion pipeline to cleanse and process
                  multi-format data, structuring it into rich semantic
                  representations for superior retrieval.
                </p>
              ...
              <article className={cn("flex flex-col bg-standard", styles.card)}>
                ...
                <p>
                  Combine vector search, BM25, and custom scoring with advanced
                  re-ranking to deliver unmatched answer accuracy and context
                  relevance.
                </p>
              ...
              >
                ...
                <p>
                  Build powerful agents in an all-in-one platform, seamlessly
                  integrating RAG, tools, and MCPs within visual workflows.
                </p>
            ...
            <section className="space-y-12" aria-label="Solutions">
              ...
              <article className="flex flex-col desktop:flex-row gap-8 desktop:gap-16">
                <div>
                  ...
                  <p>
                    This workflow automates company data collection and
                    consolidates financial metrics with research insights.
                    Enables advanced stock analysis through autonomous planning
                  ...
                  <p className="mb-0">
                    ...
                    are combined with financial metrics to yield a complete
                    investment report.
                  </p>
                </div>
              ...
              <article className="flex flex-col desktop:flex-row gap-8 desktop:gap-16">
                <div>
                  ...
                  <p>
                    This workflow provides structured maintenance guidance by
                    accurately sourcing content from internal manuals, with
                  ...
                  <p className="mb-0">
                    ...
                    manuals, integrates supplementary external technical data,
                    and produces clear execution instructions.
                  </p>
                </div>
