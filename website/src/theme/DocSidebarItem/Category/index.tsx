...
function CollapseButton({
  ...
  return (
    <button
      ...
      type="button"
      className="clean-btn ml-2 px-2 self-stretch flex items-center"
      onClick={onClick}
    >
      <Icon
  ...
  return (
    ...
    >
      ...
      >
        <Link
          className={cn(
            'overflow-hidden flex items-center flex-1 leading-tight',
            level === 1 ? 'py-2' : 'py-1',
            isActive && 'text-standard',
          )}
      ...
      <div
        className={cn(
          level === 1 && 'ml-2 border-0 border-l-1 border-solid border-standard',
        )}
      >
        <Collapsible
          lazy
          ...
          className={cn(
            'list-none block m-0 p-0 mt-2 pt-2',
            level === 1 && '-ml-px pb-2',
          )}
          collapsed={collapsed}
        >
