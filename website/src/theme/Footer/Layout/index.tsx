  ...
  return (
    ...
    >
      <div className="flex flex-wrap flex-col desktop:flex-row desktop:flex-nowrap items-stretch">
        {(logo || copyright) && (
          <div className="max-desktop:mt-16 max-desktop:order-last max-desktop:text-center desktop:mr-auto flex-none 2xl:flex-1">
            {logo && <div className="mb-12">{logo}</div>}
            {copyright}
          </div>
        )}

        <div className="p-0 max-desktop:w-full desktop:container desktop:ml-40 xl:w-1/2 2xl:w-auto 2xl:flex-1">
          {links}
        </div>
      </div>
    </footer>
